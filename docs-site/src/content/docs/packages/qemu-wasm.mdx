...
|--------|--------|------|-------|
| Boot time | ~1s | ~5s | 5x |
| CPU benchmarks | baseline | 10-20x slower | — |
...
- [packages/qemu-wasm/Dockerfile](https://github.com/user/blob/main/packages/qemu-wasm/Dockerfile)
- [packages/qemu-wasm/scripts/](https://github.com/user/blob/main/packages/qemu-wasm/scripts/)
- [packages/qemu-wasm/patches/](https://github.com/user/blob/main/packages/qemu-wasm/patches/)
