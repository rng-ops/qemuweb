...
QemuWeb's virtual networking system enables complex network topologies with multiple VMs, routers, switches, and firewall rules—all running entirely in your browser.
...
<div style="background: var(--sl-color-gray-6); border-radius: 1rem; padding: 1rem; margin: 2rem 0;">
  <img src="/qemuweb/diagrams/04-virtual-networking.svg" alt="Virtual Networking" style="width: 100%; height: auto;" />
</div>
...
| Feature | Status |
|---------|--------|
| Single VM networking | ✅ Complete |
| NAT gateway | 🔶 In Progress |
| Multi-VM topology | 🔶 Planned |
| Virtual switches | 🔶 Planned |
