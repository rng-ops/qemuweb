...
- [packages/sidecar-proto/src/types.ts](https://github.com/user/qemuweb/blob/main/packages/sidecar-proto/src/types.ts)
- [packages/sidecar-proto/src/localTransport.ts](https://github.com/user/qemuweb/blob/main/packages/sidecar-proto/src/localTransport.ts)
- [packages/sidecar-proto/src/remoteTransport.ts](https://github.com/user/qemuweb/blob/main/packages/sidecar-proto/src/remoteTransport.ts)
- [packages/sidecar-proto/src/mockSidecar.ts](https://github.com/user/qemuweb/blob/main/packages/sidecar-proto/src/mockSidecar.ts)
