...
- [packages/vm-config/src/types.ts](https://github.com/user/qemuweb/blob/main/packages/vm-config/src/types.ts)
- [packages/vm-config/src/profiles.ts](https://github.com/user/qemuweb/blob/main/packages/vm-config/src/profiles.ts)
- [packages/vm-config/src/builder.ts](https://github.com/user/qemuweb/blob/main/packages/vm-config/src/builder.ts)
- [packages/vm-config/src/networking.ts](https://github.com/user/qemuweb/blob/main/packages/vm-config/src/networking.ts)
