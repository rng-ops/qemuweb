...
<div style="background: var(--sl-color-gray-6); border-radius: 1rem; padding: 1rem; margin: 2rem 0;">
  <img src="/qemuweb/diagrams/02-cow-storage.svg" alt="Copy-on-Write Storage" style="width: 100%; height: auto;" />
</div>
...
<div style="background: var(--sl-color-gray-6); border-radius: 1rem; padding: 1rem; margin: 2rem 0;">
  <img src="/qemuweb/diagrams/05-atlas-store.svg" alt="Atlas Store" style="width: 100%; height: auto;" />
</div>
